...
await send("Page.addScriptToEvaluateOnNewDocument", { source: "delete Element.prototype.replaceChildren; delete DocumentFragment.prototype.replaceChildren; delete Document.prototype.replaceChildren; delete Array.prototype.at; delete Array.prototype.findLastIndex; delete String.prototype.replaceAll; delete Object.groupBy; delete Map.groupBy; delete globalThis.WeakRef;" });
...
const legacyWebView = await evaluate("typeof Element.prototype.replaceChildren === 'function' && typeof DocumentFragment.prototype.replaceChildren === 'function' && typeof Array.prototype.at === 'function' && typeof Array.prototype.findLastIndex === 'function' && 'a-a'.replaceAll('-', '') === 'aa' && typeof Object.groupBy === 'function' && typeof Map.groupBy === 'function' && new WeakRef({}).deref() !== undefined");
